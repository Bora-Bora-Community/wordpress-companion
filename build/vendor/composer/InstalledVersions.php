 ...
 */
namespace _PhpScoper9a3678ae6a12\Composer;

use _PhpScoper9a3678ae6a12\Composer\Autoload\ClassLoader;
use _PhpScoper9a3678ae6a12\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    public static function getInstalledPackages()
    {
        ...
        return \array_keys(\array_flip(\call_user_func_array('_PhpScoper9a3678ae6a12\\array_merge', $packages)));
    }
    /**
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper9a3678ae6a12\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
