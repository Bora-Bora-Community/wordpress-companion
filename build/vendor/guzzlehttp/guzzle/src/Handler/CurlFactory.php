...
use _PhpScoper9a3678ae6a12\GuzzleHttp\Exception\ConnectException;
use _PhpScoper9a3678ae6a12\GuzzleHttp\Exception\RequestException;
use _PhpScoper9a3678ae6a12\GuzzleHttp\Promise as P;
use _PhpScoper9a3678ae6a12\GuzzleHttp\Promise\FulfilledPromise;
use _PhpScoper9a3678ae6a12\GuzzleHttp\Promise\PromiseInterface;
use _PhpScoper9a3678ae6a12\GuzzleHttp\Psr7\LazyOpenStream;
use _PhpScoper9a3678ae6a12\GuzzleHttp\TransferStats;
use _PhpScoper9a3678ae6a12\GuzzleHttp\Utils;
...
class CurlFactory implements CurlFactoryInterface
{
    ...
    private function applyHandlerOptions(EasyHandle $easy, array &$conf) : void
    {
        ...
        if (!isset($options['sink'])) {
            ...
            $options['sink'] = \_PhpScoper9a3678ae6a12\GuzzleHttp\Psr7\Utils::tryFopen('php://temp', 'w+');
        }
        $sink = $options['sink'];
        if (!\is_string($sink)) {
            $sink = \_PhpScoper9a3678ae6a12\GuzzleHttp\Psr7\Utils::streamFor($sink);
