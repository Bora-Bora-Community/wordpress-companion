...
use _PhpScoper9a3678ae6a12\WP_Term_Query;
use _PhpScoper9a3678ae6a12\WP_User_Query;
use _PhpScoper9a3678ae6a12\WP_Comment_Query;
/**
...
class Association_Field extends Field
{
    ...
    {
        $this->wp_toolset = \_PhpScoper9a3678ae6a12\Carbon_Fields\Carbon_Fields::resolve('wp_toolset');
