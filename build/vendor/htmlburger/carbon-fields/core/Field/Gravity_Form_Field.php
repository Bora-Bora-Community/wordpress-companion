...
class Gravity_Form_Field extends Select_Field
{
    ...
    {
        if (\class_exists('_PhpScoper9a3678ae6a12\\RGFormsModel') && \method_exists('\\RGFormsModel', 'get_forms')) {
            return \true;
        }
        return \false;
    }
    ...
    protected function get_gravity_form_options()
    {
        ...
        $forms = \_PhpScoper9a3678ae6a12\RGFormsModel::get_forms(null, 'title');
