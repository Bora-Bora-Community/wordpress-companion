...
use _PhpScoper9a3678ae6a12\Carbon_Fields\Container\Condition\Factory;
use _PhpScoper9a3678ae6a12\Carbon_Fields\Container\Fulfillable\Translator\Array_Translator;
...
class Fulfillable_Collection implements Fulfillable
{
    ...
    {
        return \_PhpScoper9a3678ae6a12\Carbon_Fields\Carbon_Fields::resolve('container_condition_fulfillable_collection');
    }
    /**
