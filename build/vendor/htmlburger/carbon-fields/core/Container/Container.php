...
namespace _PhpScoper9a3678ae6a12\Carbon_Fields\Container;
...
use _PhpScoper9a3678ae6a12\Carbon_Fields\Field\Group_Field;
...
use _PhpScoper9a3678ae6a12\Carbon_Fields\Datastore\Datastore_Holder_Interface;
        ...
        while (!empty($hierarchy_left)) {
            ...
            foreach ($field_group as $f) {
                ...
                if (empty($hierarchy_left)) {
                    ...
                    if (!$f instanceof \_PhpScoper9a3678ae6a12\Carbon_Fields\Field\Complex_Field) {
                        return null;
                    }
