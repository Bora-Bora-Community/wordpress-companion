...
namespace _PhpScoper9a3678ae6a12\Carbon_Fields\Helper;

use _PhpScoper9a3678ae6a12\Carbon_Fields\Datastore\Datastore;
use _PhpScoper9a3678ae6a12\Carbon_Fields\Exception\Incorrect_Syntax_Exception;
use _PhpScoper9a3678ae6a12\WP_Query;
/**
...
class Helper
{
    ...
    {
        \_PhpScoper9a3678ae6a12\Carbon_Fields\Carbon_Fields::verify_fields_registered();
        $repository = \_PhpScoper9a3678ae6a12\Carbon_Fields\Carbon_Fields::resolve('container_repository');
        if ($container_id) {
    ...
    public static function input()
    {
        ...
        if (\_PhpScoper9a3678ae6a12\Carbon_Fields\COMPACT_INPUT) {
    ...
    {
        if (isset($input[\_PhpScoper9a3678ae6a12\Carbon_Fields\COMPACT_INPUT_KEY])) {
            $inputs = $input[\_PhpScoper9a3678ae6a12\Carbon_Fields\COMPACT_INPUT_KEY];
