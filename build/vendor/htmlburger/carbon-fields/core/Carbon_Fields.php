...
use _PhpScoper9a3678ae6a12\Carbon_Fields\Loader\Loader;
use _PhpScoper9a3678ae6a12\Carbon_Fields\Container\Repository as ContainerRepository;
use _PhpScoper9a3678ae6a12\Carbon_Fields\Toolset\Key_Toolset;
use _PhpScoper9a3678ae6a12\Carbon_Fields\Toolset\WP_Toolset;
...
use _PhpScoper9a3678ae6a12\Carbon_Fields\Service\Revisions_Service;
...
use _PhpScoper9a3678ae6a12\Carbon_Fields\REST_API\Router as REST_API_Router;
use _PhpScoper9a3678ae6a12\Carbon_Fields\REST_API\Decorator as REST_API_Decorator;
use _PhpScoper9a3678ae6a12\Carbon_Fields\Event\Emitter;
use _PhpScoper9a3678ae6a12\Carbon_Fields\Event\PersistentListener;
use _PhpScoper9a3678ae6a12\Carbon_Fields\Event\SingleEventListener;
...
final class Carbon_Fields
{
    ...
    {
        $url = \_PhpScoper9a3678ae6a12\trailingslashit($directory);
        $count = 0;
        # Sanitize directory separator on Windows
        $url = \str_replace('\\', '/', $url);
        $possible_locations = array(
            WP_PLUGIN_DIR => \_PhpScoper9a3678ae6a12\plugins_url(),
            # If installed as a plugin
            WP_CONTENT_DIR => \_PhpScoper9a3678ae6a12\content_url(),
            # If anywhere in wp-content
            ABSPATH => \_PhpScoper9a3678ae6a12\site_url('/'),
        );
        foreach ($possible_locations as $test_dir => $test_url) {
            ...
            if ($count > 0) {
                return \_PhpScoper9a3678ae6a12\untrailingslashit($url);
            }
        }
        return '';
    ...
    protected static function get_default_ioc()
    {
        ...
        $ioc->register(new \_PhpScoper9a3678ae6a12\Carbon_Fields\Provider\Container_Condition_Provider());
        return $ioc;
    }
}
