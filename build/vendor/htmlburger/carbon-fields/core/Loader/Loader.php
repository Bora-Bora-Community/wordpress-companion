...
namespace _PhpScoper9a3678ae6a12\Carbon_Fields\Loader;

use _PhpScoper9a3678ae6a12\Carbon_Fields\Container\Repository as ContainerRepository;
use _PhpScoper9a3678ae6a12\Carbon_Fields\Exception\Incorrect_Syntax_Exception;
use _PhpScoper9a3678ae6a12\Carbon_Fields\Helper\Helper;
use _PhpScoper9a3678ae6a12\Carbon_Fields\Libraries\Sidebar_Manager\Sidebar_Manager;
use _PhpScoper9a3678ae6a12\Carbon_Fields\Pimple\Container as PimpleContainer;
use _PhpScoper9a3678ae6a12\Carbon_Fields\Service\Legacy_Storage_Service_v_1_5;
use _PhpScoper9a3678ae6a12\Carbon_Fields\Service\Meta_Query_Service;
use _PhpScoper9a3678ae6a12\Carbon_Fields\Service\REST_API_Service;
/**
...
class Loader
{
    ...
    public function boot()
    {
        ...
        include_once \_PhpScoper9a3678ae6a12\Carbon_Fields\DIR . '/core/functions.php';
        ...
        \_PhpScoper9a3678ae6a12\Carbon_Fields\Carbon_Fields::service('legacy_storage')->enable();
        # Enable the meta query service
        \_PhpScoper9a3678ae6a12\Carbon_Fields\Carbon_Fields::service('meta_query')->enable();
        # Enable the REST API service
        \_PhpScoper9a3678ae6a12\Carbon_Fields\Carbon_Fields::service('rest_api')->enable();
        # Enable post meta revisions service
        \_PhpScoper9a3678ae6a12\Carbon_Fields\Carbon_Fields::service('revisions')->enable();
    ...
    {
        $dir = \_PhpScoper9a3678ae6a12\Carbon_Fields\DIR . '/languages/';
    ...
    protected function enqueue_style($src, $deps = array())
    {
        ...
        wp_enqueue_style('carbon-fields-' . $src, \_PhpScoper9a3678ae6a12\Carbon_Fields\URL . '/build/' . $context . '/' . $src . $suffix . '.css', $deps, \_PhpScoper9a3678ae6a12\Carbon_Fields\VERSION);
    }
    /**
    ...
    protected function enqueue_script($src, $deps = array())
    {
        $suffix = $this->get_assets_suffix();
        $context = $this->get_assets_context();
        wp_enqueue_script('carbon-fields-' . $src, \_PhpScoper9a3678ae6a12\Carbon_Fields\URL . '/build/' . $context . '/' . $src . $suffix . '.js', $deps, \_PhpScoper9a3678ae6a12\Carbon_Fields\VERSION);
    }
    /**
     * Enqueues the assets.
     *
    ...
    public function enqueue_assets()
    {
        ...
        $revisions = \_PhpScoper9a3678ae6a12\Carbon_Fields\Carbon_Fields::service('revisions');
        wp_localize_script('carbon-fields-vendor', 'cf', apply_filters('carbon_fields_config', array('config' => array('locale' => $this->get_ui_translations(), 'pagenow' => $pagenow, 'compactInput' => \_PhpScoper9a3678ae6a12\Carbon_Fields\COMPACT_INPUT, 'compactInputKey' => \_PhpScoper9a3678ae6a12\Carbon_Fields\COMPACT_INPUT_KEY, 'revisionsInputKey' => $revisions::CHANGE_KEY, 'wp_version' => $wp_version))));
    }
    /**
    ...
    public function get_json_data()
    {
        ...
        foreach ($containers as $container) {
            ...
            if (\is_a($container, '_PhpScoper9a3678ae6a12\\Carbon_Fields\\Container\\Block_Container', \true)) {
