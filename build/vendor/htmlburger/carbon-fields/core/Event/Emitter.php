...
class Emitter
{
    ...
    {
        $listener = \_PhpScoper9a3678ae6a12\Carbon_Fields\Carbon_Fields::resolve('event_persistent_listener');
    ...
    {
        $listener = \_PhpScoper9a3678ae6a12\Carbon_Fields\Carbon_Fields::resolve('event_single_event_listener');
        $listener->set_callable($callable);
        return $this->add_listener($event, $listener);
    }
}
